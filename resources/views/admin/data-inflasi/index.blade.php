...
@section('content')
        ...
        <div class="section-body">
            <div class="card card-warning">
                <div class="card-header">
                    <h4 class="text-warning">Data Inflasi (Bulanan)</h4>
                    <div class="card-header-action">
                        <a data-collapse="#data-inlasi" class="btn btn-icon btn-warning" href="#"><i
                                class="fas fa-minus"></i></a>
                    </div>
                </div>
                <div class="collapse show" id="data-inlasi">
                    <div class="card-body">
                        <form action="{{ route('superadmin.inflasi.create') }}" class="needs-validation" novalidate=""
                            method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="data-inflasi">Data Inflasi %</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-warning text-white" id="data-inflasi">%</span>
                                    </div>
                                    <input name="inflasi" type="number" class="form-control"
                                        aria-describedby="data-inflasi" placeholder="Data Inflasi (Bulanan)"
                                        aria-label="data-inflasi" step="any" required>
                                    <div class="invalid-feedback">
                                        Wajib Memasukan Data Inflasi (Bulanan)
                                    </div>
                                </div>
                            </div>
                            {{-- <div class="form-group">
            ...
            <div class="card">
                <div class="card-header">
                    <h4>History Data Inflasi (Bulanan)</h4>
    ...
    <!-- Modal Update Data -->
    <div class="modal fade" id="edit-data-inflasi" tabindex="-1" role="dialog" aria-labelledby="edit-data-inflasi-title"
        aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-primary" id="edit-data-inflasi-title">Update Data 7 Mei 2022</h5>
                ...
                <div class="modal-body mt-2">
                    ...
                    <div class="card author-box card-primary mt-2 p-4">
                        <form class="needs-validation" novalidate="">
                            ...
                            <button hidden id="update-data-user" type="submit">kirim</button>
                        </form>
                    </div>
                </div>
...
@push('js')
    ...
    <script>
        $('.delete-data').click(function() {
            ...
            var url = "data-inflasi/delete/" + id + "";
